/* ++++++++++++++++++++++++++++++++++++++ */
/* +++ Définition de la classe Piece4 +++ */
/* ++++++++++++++++++++++++++++++++++++++ */
...
/* === Constructeur === */
/* ==================== */
Piece4::Piece4(int orient, int x, int y):Piece(orient){
...
/* ============================ */
void Piece4::selfDisplay(std::ostream& stream) const {
   std::cout << "piece 4 \n";
	for (int i = 0; i<4; i++){
...
int Piece4::get_most_right_brique(){
...
int Piece4::get_most_left_brique(){
...
void Piece4::get_positions_after_turn(int*table_i,int*table_j,int sens){
	int new_orientation;
	if(sens==Piece::TURN_RIGHT){
