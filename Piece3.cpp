/* ++++++++++++++++++++++++++++++++++++++ */
/* +++ Définition de la classe Piece3 +++ */
/* ++++++++++++++++++++++++++++++++++++++ */
...
/* === Constructeur === */
/* ==================== */
Piece3::Piece3(int orient, int x, int y):Piece(orient){
...
/* ============================ */
void Piece3::selfDisplay(std::ostream& stream) const {
   std::cout << "piece 3 \n";
	for (int i = 0; i<4; i++){
...
int Piece3::get_most_right_brique(){
...
int Piece3::get_most_left_brique(){
...
void Piece3::get_positions_after_turn(int*table_i,int*table_j,int sens){
	int new_orientation;
	if(sens==Piece::TURN_RIGHT){
