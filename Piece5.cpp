/* ++++++++++++++++++++++++++++++++++++++ */
/* +++ Définition de la classe Piece5 +++ */
/* ++++++++++++++++++++++++++++++++++++++ */
...
/* === Constructeur === */
/* ==================== */
Piece5::Piece5(int orient, int x, int y):Piece(orient){
...
/* ============================ */
void Piece5::selfDisplay(std::ostream& stream) const {
   std::cout << "piece 5 \n";
	for (int i = 0; i<4; i++){
		std::cout << *(this->brique[i]);	
	}
}
int Piece5::get_most_right_brique(){
...
int Piece5::get_most_left_brique(){
	return this->briqueref->get_position_i()-1;	
}

void Piece5::tourner(int sens){
...
void Piece5::get_positions_after_turn(int*table_i,int*table_j,int sens){
	int new_orientation;
	if(sens==Piece::TURN_RIGHT){
